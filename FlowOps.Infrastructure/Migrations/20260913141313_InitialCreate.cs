        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkflowRequests_Users_SubmittedById",
                        column: x => x.SubmittedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WorkflowRequests_WorkflowDefinitions_WorkflowDefinitionId",
                        column: x => x.WorkflowDefinitionId,
                        principalTable: "WorkflowDefinitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WorkflowRequests_WorkflowSteps_CurrentStepId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApprovalActions_Users_PerformedById",
                        column: x => x.PerformedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApprovalActions_WorkflowRequests_WorkflowRequestId",
                        column: x => x.WorkflowRequestId,
                        principalTable: "WorkflowRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApprovalActions_WorkflowSteps_StepId",
                        column: x => x.StepId,
                        principalTable: "WorkflowSteps",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attachments_WorkflowRequests_WorkflowRequestId",
                        column: x => x.WorkflowRequestId,
                        principalTable: "WorkflowRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Comments_WorkflowRequests_WorkflowRequestId",
                        column: x => x.WorkflowRequestId,
                        principalTable: "WorkflowRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalActions_PerformedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalActions_WorkflowRequestId",
                table: "ApprovalActions",
                column: "WorkflowRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_Attachments_WorkflowRequestId",
                table: "Attachments",
                column: "WorkflowRequestId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_WorkflowRequestId",
                table: "Comments",
                column: "WorkflowRequestId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkflowDefinitions_OrganizationId",
                table: "WorkflowDefinitions",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkflowRequests_CurrentStepId",
                table: "WorkflowRequests",
                column: "CurrentStepId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkflowRequests_SubmittedById",
                table: "WorkflowRequests",
                column: "SubmittedById");

            migrationBuilder.CreateIndex(
                name: "IX_WorkflowRequests_TenantId_RequestNumber",
                table: "WorkflowRequests",
                columns: new[] { "TenantId", "RequestNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_WorkflowRequests_WorkflowDefinitionId",
                table: "WorkflowRequests",
